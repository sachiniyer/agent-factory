...
type home struct {
	...
	// awaitingPane is the target of the request that raised
	// awaitingInteractive; only an enterInteractiveMsg for this pane lifts it.
	awaitingPane *store.OpenPane
