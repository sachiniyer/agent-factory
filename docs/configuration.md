...
command needs it. New and respawned panes use the current list. A pane that was
already running before an upgrade keeps the environment it started with until
