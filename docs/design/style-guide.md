...
fixed component rules, not more tokens. Indicators never animate. User-caused web disclosure may take at most 120ms, with 0ms under reduced motion; every other change, and all TUI changes, is immediate.
