...
| `dropped_events` | Cumulative source events this watch task discarded after reaching `watcher_events_per_minute`. Daemon-owned and not editable. It does not count the separately bounded durable queue's overflow or expiry |
