...
| `POST` | `/v1/CreateSession` | `title`, `title_base`, `repo_path`, `program`, `account`, `account_ambient`, `prompt`, `in_place`, `force_remote`, `backend` | Create a new session (git worktree + agent) in a repo. |
