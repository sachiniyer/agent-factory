...
| `POST` | `/v1/HandoffSession` | `title`, `repo_id`, `id`, `to`, `account`, `brief` | Continue a session under a different agent, in place: swap its agent program, keep its worktree and branch, and deliver a mission brief to the new agent. |
