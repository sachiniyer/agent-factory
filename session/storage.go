...
type InstanceData struct {
	...
	// (#2513): the daemon's own session.IsReservedRecordTitle applied to the title
	// and backend type. It is
	...
	// re-implementing IsReservedRecordTitle in TypeScript against a duplicated title
