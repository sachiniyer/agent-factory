...
// PATH. A caller that tolerates running outside a repository — the
// registry-mode TUI launch (#2477) — can still require git itself, which af's
// worktrees and sessions are built on.
