...
2 tests passed</pre><span>ctrl+] · Return to sessions</span></div>`, "┌ tidy-tests · Agent · Keyboard ┐\n│ $ ./test.sh                  │\n│ 2 tests passed               │\n└ ctrl+] · Return to sessions ─┘"},
		{"Tabs and review", "Use surface and body-sized ink labels. Only the active tab gets an accent underline and bold text; PR links use accent. Use space-2 between tabs, no pill radii. TUI selection is a raised row and cursor. Preserve keyboard routes to close, switch and split.", "review", "pane", "App-model driver · pane", `<div class="sg-bar"><span>Agent</span><strong class="sg-active">diff</strong><span style="color:var(--af-accent)">PR #128 · Open</span></div><pre>$ git diff --stat
