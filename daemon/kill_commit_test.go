...
func TestDeleteSessionRecord_EndpointDeadButWorkspaceGone_ClearsTheTombstone(t *testing.T) {
	...
	deleted, err := manager.deleteSessionRecord(repoID, "remote-ish", "", endpointDead, recordedEvidence(session.InstanceData{}))
...
func TestDeleteSessionRecord_UnknownState_StillBlocks(t *testing.T) {
	...
	deleted, err := manager.deleteSessionRecord(repoID, "unknown-state", "", unknown, recordedEvidence(session.InstanceData{}))
...
func TestDeleteSessionRecord_DiscardsUnkeyedLimitEvidence(t *testing.T) {
	...
	deleted, err := manager.deleteSessionRecord(repoID, "malformed-evidence", "", nil, recordedEvidence(evidence))
