...
func TestPersistPollChange_PublishesUnderRepoLock(t *testing.T) {
	...
	manager.persistPollChange(repo.ID, instance, otherLiveness(instance.GetLiveness()), time.Time{}, time.Time{}, false)
...
func TestPersistPollChange_PublishesRosterAsOfItsLock(t *testing.T) {
	...
	manager.persistPollChange(repo.ID, instance, instance.GetLiveness(), beforeReset, beforeObserved, true)
