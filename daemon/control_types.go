...
// caller's side.
//
// Plain values, like every other request on this plane: the control socket is
// net/rpc gob, which elides zero-value fields, so an optional pointer would
// arrive as nil (#1700). Nothing here is optional.
