...
type Manager struct {
	...
	repoStartLocks, worktreeAdmissionLocks, restoreBranchLocks map[string]*sync.Mutex
...
func newManagerShellWithOptions(cfg *config.Config, transactionID string, opts managerOptions) (*Manager, error) {
	...
	mgr := &Manager{
		...
		restoreBranchLocks:        make(map[string]*sync.Mutex),
