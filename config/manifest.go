...
var configManifest = []ManifestEntry{
	...
	},
	{
		...
		Type:       "table",
		Default:    "claude, pointed at the claude command found for the current shell environment when available",
	...
	},
	{
		...
		Tier:       TierAdvanced,
		Settable:   true,
		Enum:       []string{SSHHostKeyStrict, SSHHostKeyAcceptNew, SSHHostKeyInsecure},
		Sources:    sourceGlobalOnly,
		Precedence: precedenceGlobal,
		Merge:      MergeReplace,
		Formats:    formatTOMLJSON,
