...
var auditedRequests = map[string]reflect.Type{
	...
	"ListAccountsRequest":           reflect.TypeOf(daemon.ListAccountsRequest{}),
	...
	"ConfirmHandoffDeliveryRequest": reflect.TypeOf(daemon.ConfirmHandoffDeliveryRequest{}),
	...
	"QuotaReportRequest":            reflect.TypeOf(daemon.QuotaReportRequest{}),
